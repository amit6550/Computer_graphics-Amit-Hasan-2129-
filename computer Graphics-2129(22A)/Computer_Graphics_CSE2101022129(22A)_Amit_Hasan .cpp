...
int main() {
    ...
    initwindow(350, 450, "Menu");
                ...
                outtextxy(70, 220, "[3] Flag.");
                outtextxy(70, 250, "[4] Umbrella.");
                outtextxy(70, 280, "[5] Moving Truck.");
                outtextxy(70, 310, "[6] Village Picture.");
                outtextxy(70, 340, "[7] Exit.");
